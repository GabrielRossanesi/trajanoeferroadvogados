...
export const metadata: Metadata = {
  ...
  description: "Atuação jurídica de excelência nas áreas trabalhista, cível e administrativa. Atendimento personalizado, ética e compromisso com os seus direitos.",
  keywords: [
    "Trajano e Ferro",
  ...
  openGraph: {
    ...
    description: "Atuação de excelência nas áreas trabalhista, cível e administrativa com atendimento personalizado e foco em soluções eficientes.",
    type: "website",
    locale: "pt_BR",
  },
  robots: {
